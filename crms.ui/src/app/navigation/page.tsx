    ...
    case "Officer":
      return(
        ...
        <Toolbar>
        {
            ...
            <Button  className="nav-log-btn" variant="contained" color='error' onClick={() => {localStorage.removeItem('user'); router.replace('/user/login'); router.refresh(); }}>Logout</Button>
          </div> 
          }
        </Toolbar>
      </AppBar>
